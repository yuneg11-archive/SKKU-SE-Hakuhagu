...
module.exports.welcome = (userId) => {
  if (authenticator.authenticateUser(userId) == true) { // Registered user
    ...
    const buyerSearchTextButton = builder.getButton("상품 검색 (텍스트)", "message", "상품 텍스트 검색"); // Temp action
    const buyerSearchImageButton = builder.getButton("상품 검색 (이미지)", "message", "상품 이미지 검색"); // Temp action
    ...
    const sellerItemRegisterButton = builder.getButton("상품 등록", "message", "상품 등록"); // Temp action
    const sellerItemListButton = builder.getButton("상품 목록", "message", "상품 목록"); // Temp action
    ...
    const guideRegistrationButton = builder.getButton("회원 가입", "message", "회원 가입"); // Temp action
